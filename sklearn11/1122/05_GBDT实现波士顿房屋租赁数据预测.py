...
if __name__ == '__main__':
    ...
    flag = True
    model_file_path = './models/05_gbdt.pkl'
    ...
    if flag:
        ...
        # 5.模型的构建
        algo = GradientBoostingRegressor(n_estimators=100, max_depth=5, learning_rate=0.01, subsample=0.8)
