...
# 10. 可视化
# a. 将决策树的内部结构输出为dot的文件，然后使用graphviz将dot文件转换为图标的形式; dot -Tpdf iris.dot -o iris.pdf或者dot -Tpng iris.dot -o iris.png
from sklearn import tree
with open('images/iris.dot', 'w') as writer:
...
graph.write_png('images/iris0.png')
graph.write_pdf('images/iris0.pdf')
