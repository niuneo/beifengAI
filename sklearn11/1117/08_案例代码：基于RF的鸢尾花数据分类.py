...
# 6. 模型对象的构建
"""
n_estimators=10, 最终训练的子模型的数据
criterion="gini", 随机森林底层的决策树使用什么标准衡量数据的纯度，默认gini系数，可选gini和entropy
...
max_features="auto", 底层决策树构建后，最多允许的叶子节点数目
...
"""
algo = RandomForestClassifier(n_estimators=10, max_depth=3, oob_score=True)
