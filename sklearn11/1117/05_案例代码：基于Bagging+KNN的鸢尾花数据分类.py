# -- encoding:utf-8 --
"""
@File : 05_案例代码：基于Bagging+KNN的鸢尾花数据分类
@Author: Octal_H
@Date : 2019/10/13
@Desc : 
"""
...
max_samples=1.0, 每个子模型在训练的时候使用多少原始数据，给定百分比，默认100%
max_features=1.0, 每个子模型在训练的时候使用多少个特征属性，给定百分比，默认100%
bootstrap=True, 对于每个子模型产生训练数据的时候，是否做有放回的重采样，默认是
